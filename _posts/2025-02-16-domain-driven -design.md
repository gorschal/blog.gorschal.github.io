...
Решил выдать свою версию. Ниже полный список тем цикла — все статьи уже опубликованы.
...
6. [**Тактическое проектирование (Tactical Design)**](https://blog.gorschal.com/tactical-design.html): Применение шаблонов проектирования, таких как сущности (`Entities`), объекты-значения (`Value Objects`), агрегаты (`Aggregates`), репозитории (`Repositories`) и сервисы домена (`Domain Services`).
7. [**Итеративный процесс (Iterative Development)**](https://blog.gorschal.com/iterative-development.html).
